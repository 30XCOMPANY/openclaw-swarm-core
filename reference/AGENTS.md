...
- agent-swarm-architecture.md: 30X Swarm 原始架构材料与理念拆解，解释两层架构为何成立。
- agent-swarm-usage.md: 30X Swarm 操作手册，覆盖 `swarm` CLI/薄包装/SQLite 真相源/通知链路。
- agent-swarm-constitution-v1.md: 30X Swarm 系统宪法，定义角色契约、状态机、DoD gate 与多 CLI 驱动边界。
